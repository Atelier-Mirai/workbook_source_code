...
year = 0
while population < 1e10  # 1e10 は、10の10乗=100億です。
population *= 1 + growth_rate
year++
puts "%d 年後の人口は %ld 人です。", year, population
...
sputs str_population, "%ld", next_year_population
digit = strlenstr_population
puts "%d 桁の数です。", digit
...
puts "逆順に並び替えて、%s となりました。", str_population_reverse

# 3桁ごとにカンマを入れていきます。
comma = 0 # 今までに入れたカンマの数
for i = 0 i < digit i++ 
...
puts "カンマを追加して、%s となりました。", str_comma_population_reverse
...
puts "もう一度並び替えて、%s となりました。", str_comma_population
