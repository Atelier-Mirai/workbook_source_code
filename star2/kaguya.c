...
int main(int argc, char const *argv[]) {
  ...
  double log10_2         = log10(2);              // 約 0.3
  double log10_38oku     = log10(3844000000);     // 約 9.6
  double times           = log10_38oku / log10_2; // 約 32

  long two_32_power = (long)pow((double)2, (double)32);
  long two_42_power = (long)pow((double)2, (double)42);
